...
}" @click="toggleDarkMode()" x-init="if (document.documentElement.classList.contains('dark')) { darkMode = true; }"
    class="w-full h-full flex items-center justify-center text-red-500 dark:text-red-500">
