<div class="fixed left-0 bottom-0 z-40"
    ...
    <div x-show="cookies" class="fixed sm:left-4 bottom-20 rounded-lg bg-white dark:bg-neutral-900 shadow-2xl w-full sm:w-1/2 xl:w-1/4 max-w-[360px] overflow-hidden"
        ...
        <div class="w-full flex justify-center items-center">
            <button class="border-r border-red-500 dark:border-red-500 flex-1 px-4 py-3 text-gray-500 dark:text-white hover:text-white hover:bg-red-400 duration-150" @click="declineCookies()">I do not agree!</button>
            <button class="flex-1 px-4 py-3 text-gray-500 dark:text-white hover:text-white hover:bg-green-400 duration-150" @click="acceptCookies()">Accept</button>
        </div>
    </div>
</div>
